...
export default function ExecutiveSummary() {
  ...
  /* -----------------------------------------
      PDF Export Hook (kept for header button)
  ------------------------------------------*/
  useEffect(() => {
    const handler = async () => {
      try {
  ...
  /* -----------------------------------------
      Download PDF from inside this component
  ------------------------------------------*/
  ...
  return (
    <div className="space-y-6" id="exec-summary">
      {/* =====================================================================
          ECONOMIC PARAMETERS – list style (no input boxes)
      ===================================================================== */}
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <EconomicItem
            label="Total CAPEX ($)"
            value={economicParams.totalCAPEX?.toLocaleString()}
          />
          <EconomicItem
            label="Oil Price ($/bbl)"
          ...
          <EconomicItem
            ...
            value={economicParams.fixedOPEX?.toLocaleString()}
          />
          <EconomicItem label="Oil OPEX" value={economicParams.oilOPEX} />
          <EconomicItem label="Gas OPEX" value={economicParams.gasOPEX} />
          <EconomicItem label="Water OPEX" value={economicParams.waterOPEX} />
          <EconomicItem label="Oil NRI" value={economicParams.oilNRI} />
          <EconomicItem label="Gas NRI" value={economicParams.gasNRI} />
          <EconomicItem
            label="Discount Rate (%)"
            value={(economicParams.discountRate ?? 0) * 100}
          />
          <EconomicItem label="Ad Valorem" value={economicParams.adValorem} />
          <EconomicItem
            label="Oil Sev Tax"
      ...
      {/* =====================================================================
            PRODUCTION DECLINE GRAPH (S3 DATA) – Oil & Gas separated
      ===================================================================== */}
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl shadow-lg p-6 space-y-6">
          <h3 className="text-lg font-bold">Production Decline Preview</h3>
            ...
            {summaryRows.length > 0 && (
              <>
                ...
                <button
                  ...
                  className="cursor-pointer inline-flex items-center gap-2 rounded-lg bg-slate-800 px-3 py-1.5 text-xs font-semibold text-white shadow hover:bg-slate-900 transition-all"
                >
                  Download PDF
                </button>
              </>
...
function EconomicItem({ label, value }) {
  return (
    <div className="rounded-lg border border-slate-100 bg-slate-50 px-3 py-2 flex items-baseline justify-between gap-3">
